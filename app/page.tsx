...
export default function Home() {
  return (
    <div style={S.body}>
      ...
      {/* GALERIE PHOTOS */}
      <section style={S.section}>
        <h2 style={S.h2}>En images</h2>
        <div style={S.gallery}>
          <img src="/images/produit-2.jpg" alt={PRODUCT.name} style={S.galleryImg} />
          <img src="/images/produit-3.jpg" alt={PRODUCT.name} style={S.galleryImg} />
          <img src="/images/produit-4.jpg" alt={PRODUCT.name} style={S.galleryImg} />
        </div>
      </section>
...
const S: { [k: string]: React.CSSProperties } = {
  ...
  heroImage: { width: "100%", maxWidth: 320, borderRadius: 20, margin: "20px auto", display: "block", boxShadow: "0 10px 30px rgba(0,0,0,0.2)" },
  gallery: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: 16 },
  galleryImg: { width: "100%", borderRadius: 16, objectFit: "cover", aspectRatio: "1/1" },
